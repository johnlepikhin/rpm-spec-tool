...
| Phase | Theme | Status |
|---|---|---|
| 17 | Metadata / cross-tag consistency (P0) | in progress |
| 18 | `FilesClassifier` + first `%files` rules (P0) | not started |
...
| 22 | build-tool ↔ BuildRequires + pkgconfig (P1) | not started |
